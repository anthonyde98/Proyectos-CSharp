...
namespace Peralta100430840_lib1.Vehiculo
{
    ...
    public class Avion : IOAqui.DataInterface, IOAqui.iPersistencia
    {
        ...
        public override string ToString()
        {
            ...
            lv_str_display += " \n Nivel de Seguridad \t\t:" + av_SecurityLevel;
            lv_str_display += " \n Tripulacion \t\t:" + av_AboardTripulation;
            lv_str_display += " \n Peso del avion \t\t:" + av_Weight;
            lv_str_display += "\n -----------------------------------\n";
            return lv_str_display;
        }
        public string getAllSeguridad()
        {
            return IOAqui.DataInterface.EnumToString(typeof(NivelSeguridad));
        }
        public List<string[]> getTodoAvion()
        {
            if (av_objAirplanes == null)
                Leer();
            string lv_display = IOAqui.DataInterface.getMatrixData(av_objAirplanes, "AVIONES");
            return av_objAirplanes;
        }
        public string getTodoAvionString()
        {
            if (av_objAirplanes == null)
                Leer();
            string lv_display = IOAqui.DataInterface.getMatrixData(av_objAirplanes, "AVIONES");
        ...
        public bool Grabar()
        {
            ...
            try
            {
                ...
                lv_str_line += "|" + av_SecurityLevel;
                lv_str_line += "|" + av_AboardTripulation;
                lv_str_line += "|" + av_Weight;
